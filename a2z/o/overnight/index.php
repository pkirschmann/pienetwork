<html>
<head>
<title>Playful Invention and Exploration - Overnight Painting Machine</title>
...
<tr><td>
<span class="style4">This painting machine uses a light sensor to respond to the environment. What other types of sensors might work?</span>
</td></tr>
</table>
...
<h1 class="style3">Overnight Painting Machine</h1>


<table width="650" border="0" cellspacing="0" cellpadding="0">
<tr>

<td><img src="images/overnight_circle.jpg" width="280" height="250"></td>
...
<td><span class="style1"> I made a painting machine that paints when I can't, at night. The machine dips a piece of paper in the paint so that the pigment soaks in slowly and raises it out in the morning. I didn't expect the crazy patterns that would happen. <i>- Margaret</i></span></td>
<td background="../../../a2z/images/box_ew.gif"></td>
</tr><tr>
...
<table class="howToText" border="0" width="535" cellspacing="5" cellpadding="5" align="center">
  <tr>
    <td width="150"><img src="../../../a2z/images/stuff.gif" alt="stuff you need" width="150" height="66" align="middle"></td>
    <td width="337">
      <!--LIST EACH OF THE MATERIALS THAT YOU NEED FOR THE PROJECT OR IDEA-->
      <ul>
        <li>A cricket, a motor, a display, and light sensor. </li>
        <li>A motion module that can dip the paper into a container and remove it again. </li>
        <li>A cereal, oatmeal, or other tall box </li>
        <li>Cardboard </li>
        <li>String </li>
        <li>Binder clips </li>
        <li>Hot melt glue gun and glue stick </li>
        <li>Watercolors  or food coloring </li>
        <li>Paper (An absorbent, heavy-weight paper will work best.) </li>
        <li>Shallow container for water </li>
    </ul></td>
  </tr>
  ...
  <tr>
    <td><img src="images/overnight_box.jpg" width="150" height="200"></td>
    <td>First, make a stand for your overnight painter. I made a tower out of a cereal box by cutting around 3 sides of the front of the box to make a platform. I reinforced the box with some pieces of cardboard.</td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/overnight_morning.jpg" width="150" height="200"></td>
    <td><p>With the front of the box cut away, you will be able to center the paint container beneath the paper.</p></td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/reel.gif" width="150" height="142"></td>
    <td>You can use a motion module to lower the paper into the pan of paint and raise it back up again. I chose the Reel. <a href="../../../a2z/m/modules/reel/">Learn how to build the Reel. </a></td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/attach_string.jpg" width="150" height="121"></td>
    <td>Next, attach the string to the reel. Tie the end of the string around the wheel and use a dot of hot glue to hold it in place. </td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/clip.jpg" width="150" height="226"></td>
    <td>Use a binder clip (or paper clip) to attach the paper to the string. Tie it in place. </td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/dip.jpg" width="150" height="162"></td>
    <td><p>Make sure the string will be the right length to lower the paper into the water. </p>
        <p>My painting machine used a light sensor. I experimented with the light sensor and a display to figure out what the light level would be at dusk.</p></td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><a href="images/program_large.gif"><img src="images/program_small.gif" width="150" height="135" border="2"></a></td>
    <td><p>Next, program your machine to make overnight paintings. My program turned on the motor to lower the paper when the light level dropped below 30, and turned the motor back on when the light level went above 29. </p>
        <p><a href="images/program_large.gif">See a larger image of the program. </a></p></td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/overnight_dropper.jpg" width="150" height="113"></td>
    <td>When you're ready to make a painting, pour about 1/2&quot; of water in your pan, and add watercolor paint or food coloring. Don't be afraid to add lots of coloring - it will make your painting brighter.</td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/morning.jpg" width="150" height="170"></td>
    <td>As you sleep, the color slowly soaks into the paper and in the morning - a suprise. These two were made with red and yellow food coloring. </td>
  </tr>
  <tr>
    <td colspan="2"><img src="../../../a2z/images/line_500.gif" width="502" height="12"></td>
  </tr>
  <tr>
    <td><img src="images/overnight_green.jpg" width="108" height="150"></td>
    <td>Try combining colors - like green and blue, or yellow and red. Sometimes you'll get interesting patterns. </td>
  </tr>
</table>
<!-- box bottom code -->
</td>
...
<tr>
  <td height="5" align="center"><a href="../../../a2z/m/modules/">Find a useful Motion Module </a></td>
</tr>
<tr>
  <td><div align="center"><img src="../../../a2z/images/shortline.gif" width="249" height="12"></div></td>
</tr>
<tr>
                <td align="center"><a href="../../../ideas/?idea=83">Read 
                  about Margaret's Hot-and-Cold painting machine </a></td>
</tr>
<tr>
  <td align="center"><div align="center"><img src="../../../a2z/images/shortline.gif" width="249" height="12"></div></td>
</tr>
<tr>
  <td align="center"><a href="../../../a2z/s/spinart/">Make a painting machine that spins. </a></td>
</tr>
</table>
