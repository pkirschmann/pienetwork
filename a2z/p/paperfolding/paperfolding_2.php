<html>
<head>
<title>Playful Invention and Exploration - More About Paperfolding</title>
...
<h1 class="style3">More About Paperfolding</h1>
...
<td><img src="images/paper2_circlemobius.jpg" width="280" height="250"></td>
...
<td>
<!-- this is the text that gives a personal introduction to the activity --><span class="style1">I love folding paper and cutting and shaping cardboard into new forms. Much of my artwork is about transforming two-dimensional images into three-dimensional forms. Building with paper is a perfect match with crickets - you can make really interesting shapes that are light and easy to connect to motors or sensors.<i>-Margaret</i></span></td>
<td background="../../../a2z/images/box_ew.gif"></td>
</tr><tr>
...
<td width="150"><img src="images/paper2_samples.jpg" width="150" height="113"></td>

<td> All of these shapes are based on the same kinds of folds that create the leaf on the previous page. </td>
</tr>
...
<tr>
<td><img src="images/paper2_square.jpg" width="150" height="113"></td>
<td> If you look closely, you can kind of see how it is basically four simplified leaves put together (the tip of each leaf are the corners of the square). Forms like this - that can fold and unfold - are sometimes called deployable structures. An engineer named Davide De Focatiis has been studying leaves to design deployable structures. I found these patterns through his <a href="http://www.deployables.net/ddf/academic/deployable.html">web pages</a>. </td>
</tr>
...
<tr>
<td><img src="images/paper2_trianglefold.jpg" width="150" height="113"></td>
<td> I've been wanting to use this fold to fold printed paper around a structure. This paper is printed with an image of the sky and clouds. </td>
</tr>
...
<tr>
<td><img src="images/paper2_triangles.jpg" width="150" height="113"></td>
<td> This is a <a href="http://www.ics.uci.edu/%7Eeppstein/junkyard/resch.pdf">pattern</a> for the fold above. It was designed (and patented) by Ron Resch. This system was used to make the <a href="http://www.cuug.ab.ca:8001/VT/vegreville.html">world's largest Ukrainian egg</a>, in Alberta, Canada. </td>
</tr>
...
<tr>
<td><img src="images/paper2_spiralgo.gif" width="150" height="113"></td>
<td> This is the coolest deployable structure I've found. It starts as a little cup-shaped thing you can hold in the palm of your hand and unfurls beautifully! This pattern was designed by Simon Guest. One really interesting thing about this structure is that the folds are slightly curved. You'll find two versions of the <a href="http://www2.eng.cam.ac.uk/%7Esdg/dstruct/wrapping.html">pattern on his web site</a>. One is simpler - it requires only moderate patience to make. The other requires extreme patience. But it turns out really nice. </td>
</tr>
...
<tr>
<td><img src="images/paper2_flowergarden.jpg" width="149" height="112"></td>
<td> We used this design to make an interactive flower garden at a workshop at the MIT Museum in Cambridge. </td>
</tr>
