<html>
<head>
<title>Playful Invention and Exploration - Marble Mazes</title>
...
<h1 class="style3">Marble Mazes</h1>


<table width="650" border="0" cellspacing="0" cellpadding="0">
<tr>

<td><img src="images/working.jpg" width="280" height="250"></td>
...
<td><span class="style1">Try making obstacles to avoid, like holes in the bottom or sides - or tunnels that cause your marble to magically switch direction! Get creative with paint, stickers, or just odds and ends laying around! - <em>Roger</em></span> </td>
<td background="../../../a2z/images/box_ew.gif"></td>
</tr><tr>
...
<td>
  ...
  <ul>
    <li> Plywood board (about 12&quot;square) </li>
    <li> 1/4&quot; strips of scrap wood </li>
    <li> Hot melt glue gun and glue sticks </li>
    <li> Strips of <a href="../../c/copper_foil/">copper foil</a> </li>
    <li> Alligator clip sensor (You can learn how to make one <a href="a2z/a/alligator-clip-sensor/">here</a>.) </li>
    <li> Cricket </li>
    <li> Motor and connector </li>
    <li> Legos and other building materiala (wood scraps, paper, cardboard, plastic toys, etc) </li>
    <li> Alternative materials: You could also use squares of cardboard for the base, and straws, popsicle sticks, or pieces of cardboard to make the maze. </li>
</ul></td>
</tr>
...
<tr>
<td><img src="images/wood_strips.jpg" width="150" height="129"></td>
<td>
  <p> Start building your maze - we're using an 8&quot; square piece of plywood and 1/8&quot; and 1/4&quot; square wooden strips for the walls of the maze. You could also use other materials - for example cardboard and drinking straws could also work. </p></td>
</tr>
...
<tr>
<td><img src="images/testing.jpg" width="150" height="127"></td>
<td> <em>Hint</em>: Make sure you leave enough room between the walls for your marble to easily move through the maze. Test it out with your marble to make sure! </td>
</tr>
...
<tr>
<td><img src="images/attach_sensor.jpg" width="150" height="167"></td>
<td>
  <p> Now, make a sensor and add it to the maze. </p>
  <p> In this maze, two pieces of copper foil make the sensor. When the metal marble rolls between the pieces of copper it completes the circuit and a motor turns on. </p>
  <p> Clip the alligator clips to each of the copper strips and glue then in place on the maze with the copper folded over the edge of the maze. Make sure they are close enough together, but not touching. </p>
  <p> Plug the other end of the alligator clip sensor into the sensor spot on the cricket. </p></td>
</tr>
...
<tr>
<td><img src="images/program.jpg" width="139" height="128"></td>
<td> For this maze, Teresa and Roger wrote a program that when the sensor is triggered, a motor will turn on for 30 seconds. Their program says &quot;Wait until sensor a is touched, then turn motor a on for 3 seconds&quot;. </td>
</tr>
...
<tr>
<td><img src="images/button_test.jpg" width="150" height="157"></td>
<td> If your maze isn't working the way you expect, make sure the marble makes a good connection with the copper strips. </td>
</tr>
...
<tr>
<td><img src="images/maze_roger.jpg" width="150" height="157"></td>
<td>
  <p> What kind of suprise will players find if they successfully complete your maze? </p>
  <p> Roger and Theresa attached a little figure of a woman with her suitcase (and her little dog, too!) on astro-turf which spins around when the sensor is triggered. </p></td>
</tr>
...
<tr>
<td><img src="images/3dmaze.jpg" width="168" height="182"></td>
<td> OTHER THINGS TO TRY: <br>
  - Use a voice recorder and record your voice to be activated by the sensor. <br>
  - Add a second sensor - if you have other types of sensors use them (reflectant, etc.) <br>
  - Try attaching the copper sensor strips in a different way - make it more challenging to play! <br>
  - Try making hidden tunnels with secret chambers with hidden surprises! </td>
</tr>
...
<tr>
  <td align="center"> Like a maze, a domino run is a challenge. <a href="../../d/domino/">Learn to make one.</a> </td>
</tr>
<tr>
<td align="center"><img src="../../../a2z/images/shortline.gif" width="249" height="12"></td>
</tr>
<tr>
  <td align="center"> <a href="../../c/copper_foil/">Make a sensor with copper foil. </a></td>
</tr>
<tr>
<td align="center"><img src="../../../a2z/images/shortline.gif" width="249" height="12"></td>
</tr>
<tr>
  <td align="center"> <a href="http://www.smm.org/studio3d/mar_mach.html">Try making a marble machine: here's a way to build one.</a> </td>
</tr>
</table>
