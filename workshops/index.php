<html>
<head>
<title>Playful Invention and Exploration - Workshops</title>
...
<tr><td>
<span class="style4">These are just some of the possible thematic workshops you can try using Crickets</span>
</td></tr>
</table>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><p><img src="/images/playful_header_sm.gif" width="494" height="66"></p>
    </td>
  </tr>
  <tr> 
    <td width="650" align="center" valign="top"> <h1 class="style3">Workshops<br>
      <img src="/a2z/images/line_500.gif" width="502" height="12"></h1>
      <table border="0" cellpadding="0" cellspacing="0">
        <tr> 
          <td width="30" height="293"></td>
          <td width="535" valign="top"> 
            <!-- end box top code -->
            <table width="599" border="0" align="center" cellpadding="5" cellspacing="5">
              <tr> 
                <td height="100" valign="top"><table width="260" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="30"><img src="/a2z/images/box_nw.gif" width="30" height="30" alt=""></td>
                      <td width="200"><img src="/a2z/images/box_n.gif" width="200" height="30" alt=""></td>
                      <td width="80"><img src="/a2z/images/box_ne.gif" width="30" height="30" alt=""></td>
                    </tr>
                    <tr> 
                      <td background="/a2z/images/box_ew.gif"></td>
                      <td><span class="style1"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif">There 
                        are many different ways to use Crickets in PIE workshops. 
                        Here's more information on plans, ideas, and goals underlying 
                        several PIE workshops. </font></span></td>
                      <td background="/a2z/images/box_ew.gif"></td>
                    </tr>
                    <tr> 
                      <td><img src="/a2z/images/box_sw.gif" width="30" height="30" alt=""></td>
                      <td><img src="/a2z/images/box_s.gif" width="200" height="30" alt=""></td>
                      <td><img src="/a2z/images/box_se.gif" width="30" height="30" alt=""></td>
                    </tr>
                  </table>
                  <br> 
                  <p align="left"><a href="chain_reaction_workshop/index.php"><img src="images/workshop-contraptions2.jpg" width="274" height="128" border="0"></a></p>
                  <p align="center"><br>
                    <br>
                  <a href="gastrobots-workshop/index.php"><img src="images/workshop-gastrobots2.jpg" width="208" height="145" border="0"></a></p>
                  <p align="center">&nbsp;</p>
                  <p align="center">&nbsp;</p>
                </td>
                <td width="48%" height="100" valign="top"><div align="right"> 
                    <p><br>
                    </p>
                    <p align="left"><a href="art_machine_workshop/index.php"><img src="images/workshop-art2.jpg" width="208" height="145" border="0"><br>
                      </a></p>
                    <p align="left"><a href="park_workshop/index.php"><img src="images/workshop-park.jpg" width="208" height="145" border="0"><br>
                      <br>
                      <br>
                      </a><a href="light_workshop/index.php"><img src="images/workshop-light.jpg" width="274" height="128" border="0"><br>
                      </a><a href="gastrobots-workshop/index.php"><br>
                      </a><a href="/workshops/smart_house_workshop/index.php"><img src="images/workshop-smart2.jpg" width="208" height="145" border="0"></a><br>
                    </p>
                  </div></td>
              </tr>
              <tr> 
