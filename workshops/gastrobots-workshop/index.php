...
<tr align=center>
<td><h1 class="style3">Gastrobots: Food for Thought</h1></td>
</tr>
<tr>
<td valign="top">
<table class="howToText" border="0" width="530" cellspacing="5" cellpadding="5" align="center">
<tr align="left" valign="top">

<td height="109" colspan="2"><div align="center">
  <p>Photos and descriptions from <a href="http://www.mit.edu/%7Esdh/invention_studio/">MIT
      Museum Invention Studio
Scrapbook</a></p>
  <p>&quot;Choose from a menu of food options to control
              your creations. Use asparagus,
              lemons, and cream-filled Twinkies&#8482; to complete an electrical
              circuit and determine the behaviors of your own fantastic invention.&quot;<br>
...
<tr>
  <td height="37" colspan="2"><p>- To have fun experimenting with conductive
      properties of food</p>
    <p>- To get a better sense of circuits and what materials are more or less
      conductive. </p></td>
</tr>
<tr>
...
<tr>
  ...
  <td valign="top"><p>- 
    ...
    cheese, meat, juice, fruits, vegetables, soy sauce, cream-filled pastries
      (mostly foods that are conductive--moist and/or salty)<br>
    - Plastic specimen
      jars and copper wire<br>
      - Crickets<br>
      - Resistance sensors,  alligator clips,  paper clips<br>
      - Cricket displays
      <br>
      - LEGO motors and bricks <br>
        - paper towel and  paper plates<br>
        - small plastic zip-close bags
        <br>
        - paper or plastic tablecloths</p>
    </td>
</tr>
...
<tr>
  ...
  <td valign="top"><p>We feared a gooey nightmare. Michael, Mira and I are all
      ...
      sounded tame. Even a bit&#8230; clinical.</p>
      </td>
</tr>
<tr>
...
<tr>
  ...
  <td valign="top"><p>A table was set up full of food samples. Varieties of milk,
      cheese, meat, juice, fruits and vegetables were displayed, and some of
      them were placed in the stomachs. </p>
    <p>Here is what the table looked like before
        the workshop...</p></td>
</tr>
<tr>
  <td height="22" colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td valign="top">And here is what it looked like after the participants
    experimented.</td>
</tr>
<tr>
  <td height="22" colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td valign="top"><p>We made &quot;conductivity 
      displays&quot; that simply displayed the 
      value of the resistance sensor. 
    </p>
    <p>Each conductivity display was made of:</p>
    <p>- a Cricket<br>
      - a resistance sensor with alligator clips<br>
      - and a display</p>
    <p>&nbsp;</p>
  </td>
</tr>
...
<tr>
  ...
  <td valign="top">We also prepared LEGO windmills, and pre-programmed a few
    crickets to alter the power level of their motor in response to varying conductivity
    levels.
    Here's <a href="images/gastrobots_program_example.jpg">the program we used</a>.
    <p>&nbsp;</p>
    </td>
</tr>
...
<tr>
<td><img src="images/conductive-display.jpg" width="150" height="150" border="0"></td>
<td valign="top"><p>When visitors arrived in the room, we gave them the conductivity
    displays.
      </p>
  <p>Here is the <a href="conductive-text.html">text from the handout</a> that
    we included with the displays.</p>
  <p></p></td>
</tr>
<tr>
  <td height="22" colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td><p> Experimenting with different foods in the &quot;stomachs&quot;
      and the conductivity displays.</p>
    </td>
</tr>
<tr>
  <td height="22" colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td><p> Getting ready to test the conductivity of pickle slices...</p>
  </td>
</tr>
<tr>
  <td height="22" colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td><p>After a few minutes of testing different foods,
      we gathered back together.</p>
    <p> Kids noticed that the
          marshmallows didn't conduct very well at all, and some hypothesized
      that they might make good insulators. </p>
    <p>Kids also noticed that the lemon
        conducted
...
<tr>
  ...
  <td valign="top"><p>While everyone was still gathered in one place, we handed
      out the windmills. <a href="images/gastrobots_program_example.jpg">A printout
      of the code</a> was
...
<tr>
<td><a href="images/step3.jpg"><img src="images/step3-small.jpg" width="150" height="189" border="0"></a></td>
<td><p>The kids were totally into it. </p>
  <p>I gave everyone the option to either:</p>
  <ul>
    <li> change the program on the Crickets that control the windmills;</li>
    <li>change the windmill structure
                in some way; </li>
    <li>or, create something new whose action (or sound)
...
<tr>
  ...
  <td><p>Creating a circuit through a kiss. </p>
    </td>
</tr>
<tr>
  <td height="22" colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td><p>Re-engineering the windmills.</p>
  </td>
</tr>
<tr>
  <td colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td><p>Creating a vehicle that moves based on the conductivity of the food</p>
  </td>
</tr>
<tr>
  <td colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td><p>This group changed the windmill into a  bubble-maker. </p>
  </td>
</tr>
<tr>
  <td colspan="2"><img src="../../a2z/images/line_500.gif" width="502" height="12"></td>
...
<tr>
  ...
  <td><p>Another group changed  the windmill into a &quot;green bean machine.&quot; </p>
    <p>See a <a href="images/green_bean_machine.jpg">photo of the green bean
        machine</a> and the <a href="images/green-bean-machine.mpeg">green
...
<tr>
  ...
  <td>This is a food transporter - the resistance of its cargo determines its
    speed. Here it's carrying a pumpkin. See the <a href="images/pumpkin.mpeg">pumpkin
    movie (750K)</a><br>
  </td>
</tr>
<tr>
...
<tr>
  ...
  <td><p>Here it's carrying a chocolate cream-filled cake. See the <a href="images/twinkie.mpeg">&quot;twinkie&quot; movie
        (350K)</a>.</p>
  </td>
</tr>
<tr>
