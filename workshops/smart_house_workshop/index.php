...
<tr align=center>
<td><h1 class="style3">Smart House Workshop</h1></td>
</tr>
<tr>
<td><table class="howToText" border="0" width="535" cellspacing="5" cellpadding="5" align="center">
        <tr> 
          <td colspan="2"><p align="center">Photos and descriptions from Smart 
              House summer workshops at the Science Museum of Minnesota. </p>
            <p align="center">Create a high-tech dream home of the future. Using 
              crickets, PICO crickets or RCX and found materials, build and design 
              your mini-house. Add light, temperature, and touch sensors, and 
              program the house to do whatever you want&#8212;control the volume 
              of the stereo, open trap doors, scare away burglars, or dust itself!<br>
            </p></td>
        </tr>
        ...
        <tr> 
          <td colspan="2"><ul>
              <li>become engaged in creating a house, and in the process,
                learn about robotics, computers,
                and engineering (even if you didn't think you were interested
                in or good at robotics, computers, and engineering)<br>
              </li>
              <li> get involved in a process of design and
                redesign, and working through problems when things don't work
                as expected<br>
              </li>
              <li>learn how you can combine familiar craft and building materials
                with digital materials</li>
            </ul></td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td width="328"><ul>
              ...
              <li>Copper foil </li>
              <li>Building supplies: cardboard, 1" pink insulation foam, tagboard, 
                wood scraps . </li>
              <li>Stuff to attach with: cable ties, pipe cleaners, hot glue, glue 
                sticks, masking and duct tape </li>
              <li>Interesting recycled stuff: tubes, cups, spoons, plastic stuff 
              </li>
              <li>Stuff to decorate with: fabric scaps, glittery paper, tinsel, 
                and mylar, construction paper, "doo-dads" (little plastic toys 
                & beads), yarn </li>
              <li>Foam </li>
              <li>A selection of LEGO pieces: gears, axles, axles connectors, 
                beams, [small grey pieces]. See the EZ modules pages for ideas 
                on LEGO supplies. </li>
            </ul></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td colspan="2"><p>On the first day of the workshop we spent about an hour designing 
              and building fantasy chairs out of a selection of craft materials 
              (no boxes, no LEGO pieces). Before we started building, we looked 
              at and talked about some chairs made by designers out of unusual 
        ...
        <tr> 
          <td colspan="2"><p>Next, we looked at and talked about a variety of interesting 
              houses. I looked for examples of houses that did smart things (like 
              opening or closing skylights in response to temperature) or that 
              used unusual materials (like recycled shipping containers or packed 
              mud).</p>            <p>We found that <a href="http://www.dwellmag.com/magazine">Dwell 
              magazine</a> often features articles about futuristic houses that 
              are made of unusual materials or have high-tech or eco-friendly 
          features. </p></td>
        </tr>
        <tr>
          <td colspan="2"><div align="center"><img src="/a2z/images/line_500.gif" width="502" height="12"></div></td>
        ...
        <tr> 
          <td colspan="2"><p>We also took some time during the week to explore &quot;smart&quot; 
              features in the museum. We checked out the sensors on the elevators 
              and doors and in the bathrooms, and visited the Science House, a 
              smartly designed, zero-emissions building. </p><p><a href="http://www.smm.org/sciencehouse/" target="_blank">Read 
        ...
        <tr> 
          ...
          <td>Because it is sometimes hard to imagine how to put parts together 
            ...
            then helped groups figure out if any of the modules would be helpful 
        ...
        <tr> 
          ...
          <td><p>Fewer LEGO pieces is/are better. At the beginning of the class 
              ...
              good reason to use fewer LEGO pieces).</p>
            <p>This cool drawbridge house used only a few LEGO pieces only for 
        ...
        <tr> 
          ...
          <td><p>I worked on a house during the week. It was partially built on 
              ...
              the week.</p>
            <p>This team wanted a retractable roof for their house, so I showed 
        ...
        <tr> 
          ...
          <td>Writing labels for the houses helps the builders reflect a little 
            ...
            about it? What would you call this house?) so they're thinking about 
            it.</td>
        </tr>
        <tr>
          <td colspan="2"><div align="center"><img src="/a2z/images/line_500.gif" width="502" height="12"></div></td>
